...
def GetDiffernetialXsMu(Summarize, Bias, TrigSF, RecoSF, IsoSF, IdSF, Calib, Recoil, Energy, Indice, Name, Lum, Variable):
    ...
    if (Name.find("munu") != -1):
        IDCovMatrix = IdSF.Get("MuTTVASys_Covariance_Iter4")
        TrigCovMatrix = TrigSF.Get("TrigSys_Covariance_Iter4")
        RecoCovMatrix = RecoSF.Get("RecoSys_Covariance_Iter4")
        IsoCovMatrix = IsoSF.Get("IsoSys_Covariance_Iter4")
        RecoilCovMatrix = Recoil.Get("Recoil_Covariance_Iter4")
...
def GetFiducialXsElIls(Summarize, Bias, TrigSF, RecoSF, IsoSF, IdSF, Calib, Recoil, Energy, Indice, Name, Lum, Variable):
...
def GetSummaringTableEl1(Summarize, Bias, TrigSF, RecoSF, IsoSF, IdSF, Calib, Recoil, Energy, Indice, Name, Lum, Variable):
        print("Summarising Table")
        data       = Summarize.Get("data_hist")
        reco       = Summarize.Get("reco_hist")
        truth      = Summarize.Get("truth_hist")
...
def EdrGetSummaringTableMu(Summarize, Bias, TrigSF, RecoSF, IsoSF,  Recoil, Energy, Indice, Name, Lum, Variable):
        print("Summarising Table")
        data       = Summarize.Get("data_hist")
        reco       = Summarize.Get("reco_hist")
        truth      = Summarize.Get("truth_hist")
