...
def GetFiducialXsEl(Summarize, Bias, TrigSF, RecoSF, IsoSF, IdSF, Calib, Recoil, Energy, Indice, Name, Lum, Variable):
        ...
        if Energy == "5TeV":
            LumError = 0.016 * HUnfolded.Integral()
        if Energy == "13TeV":
            LumError = 0.015 * HUnfolded.Integral()
        ...
        print(" ----------------- size", grrr.GetXaxis().GetTitleOffset())
        grrr.GetXaxis().SetLabelSize(0.05)
        grrr.GetXaxis().SetTitleOffset(0.6)
        grrr.GetXaxis().SetTitleSize(0.07)
